...
const HeroImage = ({ variants }) => {
  return (
    <motion.div> 
      <div className='absolute right-14 top-0 translate-y-1/2 mt-[12rem] md:w-[350px] w-[350px] h-[350px] md:h-[350px] rounded-full border-[#EB10E8] border-[32px] z-10' data-aos="fade-up"></div>
