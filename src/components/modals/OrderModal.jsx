  ...
  return (
    <div>
      ...
      <div className="md:p-8 px-3 py-4 bg-[#eff3f6] mt-10 pr-0 md:ml-64">
        <div className="bg-[#eff3f6] h-screen py-4 px-4">
          <div className='flex justify-between items-center pb-4'>
            <h1 className="text-gray-600 text-xl font-Poppins">
              Orders History
            </h1>
            <div className='relative'>
              <input className='text-sm outline-none py-2 pr-4 pl-10 w-full bg-white border border-[#FF99FC] text-black focus:border-[#FF99FC]' type="text" placeholder='Search for order..'/>
